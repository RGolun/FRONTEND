...
var drewnoModule = function () {
  var drewno = [];

  var _findByGatunek = function _findByGatunek(gatunek) {
    return drewno.find(function (d) {
  ...
  return {
    create: function create(drewno) {
      if (_findByGatunek(drewno.gatunek)) console.log("Drewno o tym gatunku juz istnieje"); else drzewa.push(new _Drewno.default (drewno.gatunek, drewno.dlugosc, drewno.srednica, drewno.klasa));
},
